...
import cn.fgliu.demo.ui.NewImageDetailsActivity;
import cn.fgliu.demo.util.ImageLoader;
...
public class NewWallScrollView extends ScrollView implements OnTouchListener {
    ...
    private static Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            NewWallScrollView myScrollView = (NewWallScrollView) msg.obj;
     ...
     * @param attrs
     */
    public NewWallScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
            ...
            if (mImageView != null) {
                ...
                imageView.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(getContext(), NewImageDetailsActivity.class);
