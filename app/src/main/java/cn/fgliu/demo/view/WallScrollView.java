...
import cn.fgliu.demo.ui.ImageDetailsActivity;
...
public class WallScrollView extends ScrollView implements OnTouchListener {
    ...
    private static Handler handler = new Handler() {
        ...
        public void handleMessage(android.os.Message msg) {
            WallScrollView myScrollView = (WallScrollView) msg.obj;
    ...
    /**
     * 进行一些关键性的初始化操作，获取WallScrollView的高度，以及得到第一列的宽度值。并在这里开始加载第一页的图片。
     */
    @Override
